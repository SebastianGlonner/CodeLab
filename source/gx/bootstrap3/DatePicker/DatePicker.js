...
gx.bootstrap.DatePicker = new Class({
	...
	createPicker: function () {
		...
		var _this_Picker = this._picker;
		var showDatePicker = function() {
			_this_Picker.open();
		}.bind(this);

		this._display.input._showDatepicker = showDatePicker;
		this._display.input._setPickerDate = this.set.bind(this);
